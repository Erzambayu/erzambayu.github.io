...
class ModernPortfolio {
  ...
  updateThemeIcon() {
    ...
    if (this.themeIcon) {
      this.themeIcon.className = iconClass + ' theme-icon';
    }
    if (this.themeToggle) {
    ...
    try {
      particlesJS('particles-js', {
        particles: {
          ...
          color: {
            value: this.theme === 'dark' ? 
              ['#eb6f92', '#c4a7e7', '#f6c177', '#9ccfd8'] : 
              ['#d7827e', '#907aa9', '#56949f', '#ea9d95']
          },
          shape: {
            type: 'circle',
            stroke: {
          ...
          line_linked: {
            enable: true,
            distance: 150,
            color: this.theme === 'dark' ? '#eb6f92' : '#d7827e',
            opacity: 0.2,
            width: 1
          },
          move: {
